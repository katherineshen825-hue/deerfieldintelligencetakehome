...
This repository contains my take-home assessment for the Director of Operations role at Deerfield Intelligence, the technology and AI arm of Deerfield Management. The assessment is based on a series of simulated stakeholder interviews with the CIO, both pod leads, and all three support function partners.

The four deliverables below represent the operational foundation I would build to scale Deerfield Intelligence from 10 to 30 people over 18 months without losing the speed and culture that makes the team effective.
...
The Cross-Pod Capacity and Commitment Dashboard was built in Lovable and is fully interactive. It includes four views:

- **Pod Capacity:** Side by side capacity utilization for both pods with color coded status indicators
- **Active Projects:** Unified project list across both pods with inline editing and status tracking
